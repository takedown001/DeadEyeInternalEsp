                          ...
                          //          Log.d("Latest",latestsrc);
                                    if (!isfree) {
                                        try {
                                            ...
                                            Toast.makeText(activity, "Duration : " + data.get("time").toString().replace(" 00:00:00", "") + "min", Toast.LENGTH_SHORT).show();
