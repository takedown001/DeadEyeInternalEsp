...
public class Login extends AsyncTask<String, Void, String> {
 ...
 //   public native String Title();
    private native String URLSERVER();
    ...
    protected void onPostExecute(String s) {
        ...
        try {
          ...
          //  Log.d("test", String.valueOf(data.get("CurrVersion")));
            if (!data.get("CurrVersion").equals("v" + BuildConfig.VERSION_NAME)) {
                ...
                ab.setPositiveButton("Download", (dialog, which) -> {
                    ...
                    i.setData(Uri.parse("https://Deadeye.gcc-org.com"));
                    ...
                    alertDialog.setNegativeButton("OK!", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                                ...
                                Toast.makeText(activity, "Wait While We Are Settings Up Things", Toast.LENGTH_SHORT).show();
